...
import 'chat_bubble_test.dart' as chat_bubble_test;
import 'flight_logs_test.dart' as flight_logs_test;
import 'latlng_editor_test.dart' as latlng_editor_test;
import 'map_selector_map_view_test.dart' as map_selector_map_view_test;
import 'profile_editor_test.dart' as profile_editor_test;
import 'waypoint_stories_test.dart' as waypoint_stories_test;
...
Future<void> main() async {
  ...
  group('chat_bubble_test', chat_bubble_test.main);
  group('flight_logs_test', flight_logs_test.main);
  group('latlng_editor_test', latlng_editor_test.main);
  group('map_selector_map_view_test', map_selector_map_view_test.main);
  group('profile_editor_test', profile_editor_test.main);
  group('waypoint_stories_test', waypoint_stories_test.main);

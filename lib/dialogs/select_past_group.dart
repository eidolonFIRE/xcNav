...
void selectPastGroup(BuildContext context) {
  ...
  final pastGroupsSorted = group.pastGroups.values
      .where((element) => element.id != group.currentGroupID)
      .toList()
                                    ...
                                    Padding(
                                      ...
                                      child: Builder(builder: (context) {
                                        final delta = DateTime.now().difference(
                                            pastGroupsSorted[index].timestamp);
                                        final value = delta.inMinutes >= 60
                                            ? delta.inHours
                                            : delta.inMinutes;
                                        final unit = delta.inMinutes >= 60
                                            ? "hr"
                                            : "min";
                                        return Text(
                                          "( $value $unit ago )",

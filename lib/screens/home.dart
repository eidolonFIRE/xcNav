...
class MyHomePage extends StatefulWidget {
  const MyHomePage({Key? key, required this.initialLocation}) : super(key: key);

  final LatLng initialLocation;

  @override
  State<MyHomePage> createState() => _MyHomePageState(initialLocation);
}
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  @override
  _MyHomePageState(this.initialLocation);
    ...
    if (focusMode == FocusMode.addWaypoint) {
      ...
      showDialog(context: context, 
        builder: (context) => AlertDialog(
          ...
          actions: [
            ElevatedButton.icon(label: const Text("Add"), onPressed: (){
              Provider.of<FlightPlan>(context, listen: false).addWaypointNew("new", latlng, false);
              Navigator.pop(context);
            }, icon: const Icon(Icons.check, size: 20, color: Colors.lightGreen,)),
            ElevatedButton.icon(label: const Text("Cancel"), onPressed: ()=>{Navigator.pop(context)}, icon: const Icon(Icons.cancel, size: 20, color: Colors.red,)),
          ],
              ...
              Row(
                ...
                children: [
                  IconButton(onPressed: () {
                    Navigator.pop(context);
                    beginAddWaypoint();
                  }, icon: const Icon(Icons.add, size: 20, color: Colors.lightGreen)),
                  IconButton(onPressed: ()=>{}, icon: const Icon(Icons.upload, size: 20,)),
                  IconButton(onPressed: ()=>flightPlan.removeSelectedWaypoint(), icon: const Icon(Icons.delete, size: 20, color: Colors.red)),
                ],
              ),
              SizedBox(
                height: 300,
                child: ReorderableListView(
                  children: flightPlan.waypoints.mapIndexed((i, e) => WaypointCard(
                      key: ValueKey(e), 
                      waypoint: e, 
                      index: i,
                      onSelect: () { 
            ...
            FlutterMap(
              ...
              layers: [
                ...
                MarkerLayerOptions(
                  ...
                  markers: Provider.of<FlightPlan>(context).waypoints.map((e) => Marker(
                      // TODO: support lines
                      point: e.latlng[0],
                      // TODO: get this alignment correct (it's slightly off)
                      anchorPos: AnchorPos.align(AnchorAlign.top),
                      builder: (context) => const Icon(Icons.location_on, size: 50, color: Colors.black)
        ...
        child: Column(
          ...
          Padding(
            ...
            child: FloatingActionButton(
              heroTag: "me",
              onPressed: () => setFocusMode(FocusMode.me, Provider.of<MyTelemetry>(context, listen:false).geo.latLng), 
              backgroundColor: const Color.fromARGB(20, 0, 0, 0),
              elevation: 0,
              child: Padding(
                padding: const EdgeInsets.all(10.0),
                child: Image.asset("assets/images/icon_controls_centermap_me.png"),
              ),
            ),
          ),
          Padding(
            ...
            child: FloatingActionButton(
              ...
              child: Padding(
                padding: const EdgeInsets.all(10.0),
                child: Image.asset("assets/images/icon_controls_centermap_group.png"),
              ),
            ),
          ),
          Padding(
            ...
            child: FloatingActionButton(
              ...
              child: Padding(
                ...
                child: Image.asset("assets/images/icon_controls_zoom_in.png"),
              ),
            ),
          ),
          Padding(
            ...
            child: FloatingActionButton(
              ...
              child: Padding(
                padding: const EdgeInsets.all(15.0),
                child: Image.asset("assets/images/icon_controls_zoom_out.png"),
              ),
            ),
          ),
        ]),

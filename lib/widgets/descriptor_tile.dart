...
class _DescriptorTileState extends State<DescriptorTile> {
  ...
  Future onReadPressed() async {
    try {
      await d.read();
      SnackbarTools.show(ABC.c, "Descriptor Read : Success", success: true);
    } catch (e) {
      SnackbarTools.show(ABC.c, prettyException("Descriptor Read Error:", e), success: false);
    }
  }
  ...
  Future onWritePressed() async {
    try {
      ...
      SnackbarTools.show(ABC.c, "Descriptor Write : Success", success: true);
    } catch (e) {
      SnackbarTools.show(ABC.c, prettyException("Descriptor Write Error:", e), success: false);
    }
  }
